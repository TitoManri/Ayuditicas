...
<body>
    ...
    <nav id="CampaniasNav" class="CampaniasNav centro" style="width: 550px;">
        <h2>Solicitud creación de campaña</h2>
    </nav>
    <br><br>
    ...
    <section id="Solicitud" class="container">
        <div class="row">
            ...
            <div class="col-1"><br></div>
            <div class="col-6">
                <p class="h1 fw-bold">Título de la campaña</p>
                <?php 
                $nombreCamp = "Campaña para recoleccion de basura";
                echo '<p class="h5">',$nombreCamp,'</p>';
                ?>
                <br>
                <p class="h1 fw-bold">Descripción de campaña</p>
                <?php 
