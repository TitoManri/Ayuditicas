    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="contenido-publicacion">
                ...
                <h5 class="mt-3 text-dark">Tratamos de Ayudar al medio ambiente, tambien puedes hacerlo! </h5>
            </div>
        </div>
