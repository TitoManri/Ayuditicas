    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h1 class="ml-5 mt-3">Confirmar denuncia</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
      ...
      <section id="confirmCampana" class="container text-center">
        ...
        <form method="post" action="" id="formDenuncia">
          ...
          <div class="row justify-content-center mt-4">
            <button type="submit" id="aceptar" class="btn btn-success mx-2">Aceptar</button>
            <button type="submit" id="eliminar" class="btn btn-danger mx-2">Eliminar</button>
          </div>
        </form>
      </section>
      <!-- /.content -->
